...
export const eliminaAllegato = async (req: any, res: any) => { await ticketsService.eliminaAllegato(+req.params.allegatoId); res.sendStatus(204); }; //per cancellare un allegato
