...
//-----------------------------------------------------
//MIDDLEWARE GLOBALE PER LANCIARE ERRORI PERSONALIZZATI
//-----------------------------------------------------
...
export function errorHandler(err: any, _req: any, res: any, _next: any) { //qui lancio errori personalizzati || middleware globale per gestire gli errori
  ...
  if (err instanceof ZodError) { //qui invece mi assicuro di gestire errori di validazione su dati mal formattati in registrazione o login, in modo da restituire un messaggio chiaro all'utente
